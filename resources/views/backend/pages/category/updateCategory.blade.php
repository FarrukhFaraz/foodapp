            ...
            <div class="container " style="width: 40%;">
                <div class="row">
                    <div class="cc" style="width: 100%">
                        <form action="{{ route('categoryUpdated') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <fieldset class="container" style="width: 100%">
                                <legend class="container" style="text-align: center">Update Category</legend>
                                ...
                                <div class="container">
                                    ...
                                    <div
                                        ...
                                        <input type="text" class="form-control inp" name="id" placeholder="id"
                                            style="border-bottom: 0px" value="{{ $category['id'] }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    ...
                                    <div
                                        ...
                                        <input type="text" class="form-control inp" name="name" placeholder="name"
                                            style="border-bottom: 0px" value="{{ $category['name'] }}">
                                    </div>
                                ...
                                <div>
                                    <img id="image-display" src="{{ asset('uploads/categories/'.$category['image'] ) }}" style="margin-bottom: 10px" height="150px">
                                </div>
